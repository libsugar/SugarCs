...
public abstract class LazyBy<T>
{
    ...
    /// Make an assoc Lazy
    /// </summary>
    public static LazyBy<T> Create<P>(Func<P> selector, Func<T> getter) => new Impl<P>(getter, selector);
...
public static class LazyFunc
{
    ...
    /// </summary>
    public static Func<T> Create<T>(Func<T> fn) => new Fn<T>(fn).Function;
    /// <summary>
    /// Make a lazy function
    /// </summary>
    public static Func<P1, T> Create<P1, T>(Func<P1, T> fn) => new Fn<P1, T>(fn).Function;
    /// <summary>
    /// Make a lazy function
    /// </summary>
    public static Func<P1, P2, T> Create<P1, P2, T>(Func<P1, P2, T> fn) => new Fn<P1, P2, T>(fn).Function;
    /// <summary>
    /// Make a lazy function
    /// </summary>
    public static Func<P1, P2, P3, T> Create<P1, P2, P3, T>(Func<P1, P2, P3, T> fn) => new Fn<P1, P2, P3, T>(fn).Function;
    ...
    class Fn<T> : Lazy<T>
    {
        public Fn(Func<T> valueFactory) : base(valueFactory, true) { }
